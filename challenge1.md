...
The challenge is complete when your Foundry agent returns accurate, cited responses to enterprise knowledge queries in the playground.
...
- In your AI Foundry project, deploy the following two models:
...
Build the AI agent in Foundry and connect it to your knowledge index.
...
- Test the agent in the Foundry chat playground. Run at least five queries covering different scenarios - a direct lookup, a summary, a cross-document comparison, a recommendation, and an out-of-scope question. Confirm every in-scope answer includes a citation.
...
- The Foundry agent returns cited, grounded responses in the playground for at least 5 test queries.
